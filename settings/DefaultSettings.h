...
#define CALIBRATE_ON_SETUP true // Set to true to perform calibration
...
#define KP 4.0 // Proportional gain, increase to speed up response
#define KI 0 // Integral gain, set low
#define KD 0 // Derivative gain, set appropriately
