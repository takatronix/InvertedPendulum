...
#define TUMPBLE_DETECT false // 転倒検出を有効にする場合はtrueにする
// 転倒検出する角度(TUMPBLE_DETECTがtrueの場合のみ有効)
...
#define CALIBRATE_ON_SETUP true // キャリブレーションを行う場合はtrueにする
...
#define SAMPLE_PERIOD 0.005 // サンプリング周期(秒)
